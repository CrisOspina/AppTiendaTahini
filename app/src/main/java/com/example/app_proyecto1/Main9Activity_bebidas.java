...
public class Main9Activity_bebidas extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_main9_bebidas);
        ...
        //Consulta nombre y valor del tipo 'Bebidas'
        busqueda_bebidas();
    }

    //Consulta nombre y valor del tipo 'Bebidas'
    public void busqueda_bebidas()
    {
